...
ONEBEAN_REFERER = os.getenv("ONEBEAN_REFERER", "https://m.jlc.com/pages/coupon-page/index?id=69").strip()
ONEBEAN_CLIENT_TYPE = os.getenv("ONEBEAN_CLIENT_TYPE", "WEB").strip() or "WEB"
ONEBEAN_SECRET_KEY_VALUE = os.getenv("ONEBEAN_SECRET_KEY_VALUE", "64656661756c744b65794964").strip()
...
class OneBeanClient:
    def __init__(self, h3, access_token: str, page, user_agent: str, account_index: int):
        ...
        token_header = h3.HEADER_ACCESS_TOKEN or "x-jlc-accesstoken"
        client_type_header = h3.HEADER_CLIENT_TYPE or "x-jlc-clienttype"
        secret_key_header = h3.HEADER_SECRET_KEY or "secretkey"
        headers = {
            "user-agent": user_agent,
            "accept": "application/json, text/plain, */*",
            "accept-language": getattr(h3, "JLC_ACCEPT_LANGUAGE", "zh-CN,zh;q=0.9"),
            "origin": self.base_url,
            "referer": ONEBEAN_REFERER,
            "content-type": "application/json;charset=UTF-8",
            token_header: access_token,
            "x-jlc-accesstoken": access_token,
            client_type_header: ONEBEAN_CLIENT_TYPE,
            "x-jlc-clienttype": ONEBEAN_CLIENT_TYPE,
            secret_key_header: ONEBEAN_SECRET_KEY_VALUE,
            "secretkey": ONEBEAN_SECRET_KEY_VALUE,
        }
